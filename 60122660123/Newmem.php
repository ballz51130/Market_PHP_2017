...
<table class="table table-dark" style="height: 300px; width: 500px; align=center">
    <tbody>
        <tr>
        ...
        <br>
            <button type="submit" class="btn btn-warning">สมัคร</button> </a><a href="Glogin.php"><button type="button" class="btn btn-outline-warning">เข้าสู่เว็ปไซต์</button></a>
                </center>
    </form>
...
<a href="Newmem.php?link=index.php">
</html>